...
- Upload the signed `MailXperts-v1.5.1.aab` to an internal testing track first.
- Install Play-generated APKs on Android 8, 13, 15 and 16 test devices.
- Test adding at least two accounts, All Accounts Inbox/Sent, search, Drafts, Outbox, Scheduled, notifications, rich signatures and upgrade from v1.3-v1.5.
